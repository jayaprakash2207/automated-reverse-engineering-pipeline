...
from .extractors.plsql_extractor import PlsqlExtractor
from .extractors.oracle_forms_extractor import OracleFormsExtractor
...
EXTRACTOR_MAP = {
    ...
    "plsql": PlsqlExtractor,
    "oracle_forms": OracleFormsExtractor,
}
...
class Layer1Pipeline:
    ...
    def _execute(self):
        ...
        print(f"         packages    : {len(db_results.get('packages', []))}")
